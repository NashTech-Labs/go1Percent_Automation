describe('api testing', function () {
  ...
  it('Testing Comment of send button API', async function ({ supertest }) {
    ...
    .request("https://ticket-backend.qa.go1percent.com")
      ...
      .set(headers) // Set the request headers using the provided headers
      .send(requestBody) // Send the request payload
