...
describe('Leaderboard API Testing', function () {
  ...
  it('should retrieve Leading Practices Summary', async function ({ supertest }) {
    ...
    expect(endTime - startTime).to.be.at.most(1500);
 ...
 */
  ...
  it('should retrieve user profile activities', async function ({ supertest }) {
    ...
    for (let indexOfResponse = 0; indexOfResponse < responseBody.length; indexOfResponse++) {
      ...
      expect(object.likes).to.satisfy(value => typeof value === 'string' || value === null);
  ...
  it('should handle profile picture not found', async function ({ supertest }) {
    ...
    // Assert that the response time is within an expected range, e.g., less than or equal to 1000 milliseconds
    expect(endTime - startTime).to.be.at.most(1000);
  ...
  it('should find all the rewords', async function ({ supertest }) {
    ...
    // Assert that the execution time is less than or equal to 3000 milliseconds.
    expect(endTime - startTime).to.be.at.most(3000); // Adjust the expected range as needed
  ...
  it('verify the points in points table', async function ({ supertest }) {
    ...
    // Assert that the execution time is less than or equal to 3000 milliseconds.
    expect(endTime - startTime).to.be.at.most(3000);
