...
const RewardsPageUIAutomationUser: NightwatchTests = {
    ...
    "Should be able to see rewards page on expanding leaderboard and clicking rewards button": () => {
        sessionsPage
    ...
    "Should be able to switch between forCompetency and Individual Buttons": () => {
        sessionsPage
    ...
    "Should be able to see reward points on loading all rewards": () => {
    ...
    "Should be able to click on redeem button": () => {
        sessionsPage
           .clickOnRedeemButton()
     ...
     "Should be able to close popup message box when no button is clicked": (browser: NightwatchBrowser) => {
        sessionsPage
            .clickOnNoButton()
    ...
    "should display message when yes button is clicked": () => {
        sessionsPage
...
export default RewardsPageUIAutomationUser;