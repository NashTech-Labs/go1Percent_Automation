...
module.exports = {
    ...
    afterEach: function (browser: NightwatchBrowser) {
     ...
     "Approve a TechHub request on TechHub details page":  function (browser: NightwatchBrowser) {
    ...
    //DCTGO1-1247 : Verify user should be able to reject a TechHub request on TechHub details page (TC-399)
     "Reject a TechHub request on TechHub details page":  function(browser: NightwatchBrowser){
        techhub['Navigate to request detail page'](browser);
    ...
    "Filter through any Competency name on TechHub Approvals ": function (browser: NightwatchBrowser) {       
    ...
    "Cannot reject a TechHub without reviewer comment":  function (browser: NightwatchBrowser) {
        techhub['Navigate to request detail page'](browser);
        browser.pause(5000);
    ...
    "Open and approve any TechHub which is on review":  function (browser:NightwatchBrowser) {
    ...
    "Open and Reject any TechHub which is on review":  function(browser: NightwatchBrowser){
        techhub['Navigate to All Techhubs page'](browser);
        techhub['Apply Review status filter'](browser);
        techhub['Navigate to request detail page'](browser);
        techhub['Reject techhub request and verify'](browser);
    ...
    "Total records": function (browser: NightwatchBrowser) {        
       //browser.pause(10000);
    ...
    "Cannot approve the techhub for same person twice a day": function (browser: NightwatchBrowser) {       
    ...
    "View details of Approved TechHubs on All TechHubs page":  function (browser: NightwatchBrowser) {
        techhub['Navigate to All Techhubs page'](browser);
    ...
    "navigate to GitHub URL provided in techhub details page": function(browser: NightwatchBrowser){
        techhub['Navigate to request detail page'](browser);
        browser.pause(3000);
